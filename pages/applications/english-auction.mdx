...
3. Participants can bid by depositing KLAY greater than the current highest bidder.
4. All bidders can withdraw their bid if it is not the current highest bid.
## After the auction
1. Highest bidder becomes the new owner of NFT.
2. The seller receives the highest bid of KLAY.

```solidity filename="EnglishAuction.sol" {2} copy
